...
export function calculateReadingTime(text: string) {
    ...
    // We use a simpler regex here to just remove the first block if it looks like frontmatter
    ...
    // This is safer than a global <...> replacement which can be flagged as unsafe
